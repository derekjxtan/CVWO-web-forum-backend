class Categories::NewestsController < ApplicationController
    skip_before_action :authenticate_user, only: %i[ show ]

    # GET /categories/newest/fun&action
    ...
    def show
        ...
        @posts = Post.where("categories @> ARRAY[?]::varchar[]", category).order('created_at DESC')
